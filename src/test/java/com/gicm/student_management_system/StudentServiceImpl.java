...
// students =
// studentRepository.findByStudentNameIgnoreCaseContainingAndStatus(nameSearch,
// status);
// } else if (hasName) {
// students =
// studentRepository.findByStudentNameIgnoreCaseContaining(nameSearch);
// } else if (hasStatus) {
...
// return
// students.stream().map(this::convertToDTO).collect(Collectors.toList());
// }
...
// @Override
// public List<Student> getStudentsByFilterFull(String nameSearch, String
// status) {
// boolean hasName = nameSearch != null && !nameSearch.isBlank();
// boolean hasStatus = status != null && !status.isBlank();
...
// @Override
// public List<StudentDTO> getStudentsByStatuses(String nameSearch, List<String>
// statuses) {
// List<Student> students;
// boolean hasName = nameSearch != null && !nameSearch.isBlank();
...
// students =
// studentRepository.findByStudentNameIgnoreCaseContainingAndStatusIn(nameSearch,
// statuses);
// } else if (hasName) {
// students =
// studentRepository.findByStudentNameIgnoreCaseContaining(nameSearch);
