...
class InterviewNotesServiceImplTest {
    ...
    void testSaveInterviewNotesDTO_UpdateExisting() {
        ...
        verify(interviewNotesRepository).save(argThat(interviewNotes -> interviewNotes.getInterview1()
                ...
                interviewNotes.getInterview2().equals("Updated second interview with focus on language proficiency.") &&
                interviewNotes.getInterview3().equals("Updated third interview - final assessment completed.") &&
                interviewNotes.getOtherMemo().equals("Updated memo: Student has shown remarkable improvement.") &&
    ...
    void testSaveInterviewNotesDTO_CreateNew() {
        ...
        verify(interviewNotesRepository).save(argThat(
                interviewNotes -> interviewNotes.getInterview1().equals("Initial screening interview completed.") &&
    ...
    void testInterviewNotesSizeLimits() {
        // Test that long strings are handled (though validation should be at DTO level)
